...
const TransactionCollectionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'category': PropertySchema(
      ...
      enumMap: _TransactionCollectioncategoryEnumValueMap,
    ),
...
TransactionCollection _transactionCollectionDeserialize(
  ...
  object.category = _TransactionCollectioncategoryValueEnumMap[
  ...
  object.type = _TransactionCollectiontypeValueEnumMap[
...
P _transactionCollectionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_TransactionCollectioncategoryValueEnumMap[
    ...
    case 6:
      return (_TransactionCollectiontypeValueEnumMap[
              reader.readStringOrNull(offset)] ??
...
const _TransactionCollectioncategoryEnumValueMap = {
  r'food': r'food',
  ...
  r'travel': r'travel',
  r'salary': r'salary',
  r'freelance': r'freelance',
  r'business': r'business',
  r'gift': r'gift',
  r'investment': r'investment',
  r'other': r'other',
};
const _TransactionCollectioncategoryValueEnumMap = {
  r'food': TransactionCategory.food,
  r'transport': TransactionCategory.transport,
  r'shopping': TransactionCategory.shopping,
  r'bills': TransactionCategory.bills,
  r'entertainment': TransactionCategory.entertainment,
  r'healthcare': TransactionCategory.healthcare,
  r'education': TransactionCategory.education,
  r'travel': TransactionCategory.travel,
  r'salary': TransactionCategory.salary,
  r'freelance': TransactionCategory.freelance,
  r'business': TransactionCategory.business,
  r'gift': TransactionCategory.gift,
  r'investment': TransactionCategory.investment,
  r'other': TransactionCategory.other,
};
const _TransactionCollectiontypeEnumValueMap = {
  r'income': r'income',
  r'expense': r'expense',
};
...
extension TransactionCollectionQueryWhere on QueryBuilder<TransactionCollection,
  ...
  QueryBuilder<TransactionCollection, TransactionCollection, QAfterWhereClause>
      categoryEqualTo(TransactionCategory category) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TransactionCollection, TransactionCollection, QAfterWhereClause>
      categoryNotEqualTo(TransactionCategory category) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension TransactionCollectionQueryProperty on QueryBuilder<
  ...
  QueryBuilder<TransactionCollection, TransactionCategory, QQueryOperations>
      categoryProperty() {
    return QueryBuilder.apply(this, (query) {
