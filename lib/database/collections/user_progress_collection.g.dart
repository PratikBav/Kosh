...
void _userProgressCollectionAttach(
    IsarCollection<dynamic> col, Id id, UserProgressCollection object) {
  object.id = id;
}
...
extension UserProgressCollectionQueryWhere on QueryBuilder<
    UserProgressCollection, UserProgressCollection, QWhereClause> {
  QueryBuilder<UserProgressCollection, UserProgressCollection,
...
extension UserProgressCollectionQueryFilter on QueryBuilder<
    UserProgressCollection, UserProgressCollection, QFilterCondition> {
  QueryBuilder<UserProgressCollection, UserProgressCollection,
...
extension UserProgressCollectionQueryObject on QueryBuilder<
    UserProgressCollection, UserProgressCollection, QFilterCondition> {}

extension UserProgressCollectionQueryLinks on QueryBuilder<
    UserProgressCollection, UserProgressCollection, QFilterCondition> {}
...
extension UserProgressCollectionQuerySortThenBy on QueryBuilder<
    UserProgressCollection, UserProgressCollection, QSortThenBy> {
  QueryBuilder<UserProgressCollection, UserProgressCollection, QAfterSortBy>
      thenByCurrentLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentLevel', Sort.asc);
...
extension UserProgressCollectionQueryProperty on QueryBuilder<
    UserProgressCollection, UserProgressCollection, QQueryProperty> {
  ...
  QueryBuilder<UserProgressCollection, int, QQueryOperations>
